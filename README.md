...
- **Progressi**: in cima la card della streak (fiamma dello stato di oggi, giorni, cosa fare oggi e record; toccandola si apre la spiegazione delle tre fiamme), poi il calendario del mese e il grafico del carico (toccandolo si apre in grande, con gli allenamenti sotto), poi peso attuale, massa corporea e grafico del peso (toccandoli si apre lo storico delle misurazioni). Nel calendario i giorni di palestra sono color fuoco, e quelli in cui la streak dormiva o era ghiacciata restano pallini viola o azzurri. Dei record personali se ne vedono due, gli altri con "Mostra tutti".
...
- **Sesso alla prima apertura**: appena installata, l'app chiede se sei uomo o donna, perché i traguardi di forza delle medaglie e la figura del corpo sono diversi. Si risponde una volta sola e si cambia quando si vuole dalle Impostazioni.
- **Impostazioni**: tema chiaro/scuro (scuro di default), sesso, esportazione/importazione backup in JSON. Se non fai un backup da un mese compare un promemoria, al massimo una volta a settimana, che sparisce da solo dopo qualche secondo.
